...
class OsxHidEventSource implements HidEventSource {
    ...
    static OsxHidEventSource createPollingEventSource( OsxHidInterface inter,
                                                       long interPtr,
                                                       int queueSize,
                                                       long pollMicros,
                                                       ...
                                                       throws HidException
    {
        ...
        try {
            if( queueSize > 0 ) {
                queues = OsxQueue.create( interPtr, queueSize, elements );
    ...
    static OsxHidEventSource createPollingValueSource( OsxHidInterface inter,
                                                       long interPtr,
                                                       int queueSize,
                                                       long pollMicros,
                                                     ...
                                                     throws HidException
    {
        ...
        OsxQueue[] queues = OsxQueue.create( interPtr, queueSize, elements );
        OsxHidEventSource ret = null;
    ...
    static OsxHidEventSource createAsyncValueSource( OsxHidInterface inter, 
                                                     long interPtr, 
                                                     int queueSize, 
                                                     HidValueListener callback, 
                                                     HidElement... elements )
    ...
    private OsxHidEventSource( OsxHidInterface inter,
                               long interPtr,
                               long pollMicros,
                               HidEventListener callback,
                               List<HidElement> elements )
                               throws HidException
    {
        mInterface = inter;
        mQueues = null;
        ...
        for( int i = 0; i < mElCount; i++ ) {
            ...
            mInEvents[i].mCookie = elements.get( i ).cookie();
            mInEvents[i].mType = elements.get( i ).type();
                               ...
                               throws HidException
    {
        ...
        for( int i = 0; i < mElCount; i++ ) {
            cookieArr[i] = elements.get( i ).cookie();
        }
    ...
    protected native long newPollingEventStruct( long interPtr, 
                                                 long pollMicros, 
                                                 int elCount, 
                                                 int[] cookieArr, 
                                                 HidEvent[] eventArr )
    ...
    protected native long newQueuedPollingEventStruct( long interPtr, 
                                                       long[] queuePtrs, 
                                                       long pollMicros, 
                                                       int elCount, 
                                                       int[] cookieArr, 
    ...
    protected native long newPollingValueStruct( long interPtr, 
                                                 long pollMicros, 
                                                 int elCount, 
                                                 int[] cookieArr, 
                                                 ByteBuffer valueBuf )
    ...
    protected native long newQueuedPollingValueStruct( long interPtr, 
                                                       long[] queuePtrs, 
                                                       long pollMicros, 
                                                       int elCount, 
                                                       int[] cookieArr, 
    ...
    protected native long newAsyncEventStruct( long interPtr, 
                                               long queuePtr, 
                                               int elOffset, 
                                               int cookie, 
                                               HidEvent event )
    ...
    protected native long newAsyncValueStruct( long interPtr, 
                                               long queuePtr, 
                                               int elOffset, 
                                               int cookie, 
                                               ByteBuffer valueBuf )
